...
export function resolveSandboxDockerConfig(params: {
  ...
  return {
    ...
    hostPathPrefix: agentDocker?.hostPathPrefix ?? globalDocker?.hostPathPrefix,
    gatewayPathPrefix: agentDocker?.gatewayPathPrefix ?? globalDocker?.gatewayPathPrefix,
    createArgs: agentDocker?.createArgs ?? globalDocker?.createArgs,
